// var nut_submid_diaChi = document.getElementById("btn-TiepTuc-DiaChi")
// nut_submid_diaChi.disabled = true;
// Khóa nút cực hay
...
window.onload = function () {
    ...
    $("#btn-TiepTuc-XacNhan").click(function () {
        ...
        if (confirm("Bạn chắc chắn muốn đặt hàng?")) {
            dsGioHang = [];
            // for (let i = 0; i < dssp.maSP.length; i++) {
            //     dssp.forEach(sp => {
            //         if (sp.maSP == Number(dssp.maSP[i].masp)) {
            //             alert(sp.soluong);
            //             sp.soluong = sp.soluong - dssp.maSP[i].soluong;
            //             alert(sp.soluong);
            //         }
            //     })
            // }
        ...
        window.open("../html/trangChu.html");
    })
}
...
//     // https://laptrinhcanban.com/javascript/javascript-co-ban-den-nang-cao/chuoi-trong-javascript/tach-so-trong-chuoi-javascript/
